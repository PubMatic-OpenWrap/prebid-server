...
func TestInjectVideoEventTrackers(t *testing.T) {
	...
	tests := []struct {
		...
		// },
		{
			...
			args: args{
				externalURL: "http://company.tracker.com?eventId=[EVENT_ID]&appbundle=[DOMAIN]",
				vastXML:     `<VAST version="3.0"><Ad><Wrapper><AdSystem>prebid.org wrapper</AdSystem><VASTAdTagURI><![CDATA[nurl_contents]]></VASTAdTagURI><Impression></Impression><Creatives><Creative><Linear><TrackingEvents>[PUBMATIC_EVENT_TRACKING]</TrackingEvents></Linear><NonLinearAds><TrackingEvents>[PUBMATIC_EVENT_TRACKING]</TrackingEvents></NonLinearAds></Creative></Creatives></Wrapper></Ad></VAST>`,
				bid: &openrtb2.Bid{
					ImpID: "123",
					AdM:   "",
					NURL:  "nurl_contents",
...
// InjectVideoEventTrackers-8   107.83µ ± 1%   78.80µ ± 6%  -26.92% (n=200)

// BenchmarkInjectVideoEventTrackers-8   	   15430	     80385 ns/op	   38724 B/op	     384 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	   10000	    142909 ns/op	   38723 B/op	     384 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    8350	    127489 ns/op	   38723 B/op	     384 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	   15044	     73561 ns/op	   38724 B/op	     384 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    9430	    158924 ns/op	   38723 B/op	     384 allocs/op

// origin ci
// BenchmarkInjectVideoEventTrackers-8   	    5634	    202508 ns/op	   59981 B/op	     824 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    6426	    181825 ns/op	   59980 B/op	     824 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    6810	    205918 ns/op	   59980 B/op	     824 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    7656	    224804 ns/op	   59980 B/op	     824 allocs/op
// BenchmarkInjectVideoEventTrackers-8   	    7695	    215629 ns/op	   59980 B/op	     824 allocs/op
