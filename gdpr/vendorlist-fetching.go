...
func vendorListURLMaker(vendorListVersion uint16) string {
	if vendorListVersion == 0 {
		return "http://vendor-list.consensu.org/v2/vendor-list.json"
	}
	return "http://vendor-list.consensu.org/v2/archives/vendor-list-v" + strconv.Itoa(int(vendorListVersion)) + ".json"
}
