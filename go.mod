...
replace git.pubmatic.com/vastunwrap => git.pubmatic.com/PubMatic/vastunwrap v0.0.0-20250401084343-a66de1c2f419
...
require (
	...
	github.com/PubMatic-OpenWrap/fastxml v0.0.0-20250328125844-820ee8310476
