...
replace git.pubmatic.com/vastunwrap => git.pubmatic.com/PubMatic/vastunwrap v0.0.0-20250410030309-6ee3e0cdbc88
...
require (
	...
	github.com/PubMatic-OpenWrap/fastxml v0.0.0-20250409201819-9f65bb2568da
