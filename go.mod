...
replace git.pubmatic.com/vastunwrap => git.pubmatic.com/PubMatic/vastunwrap v0.0.0-20250403115403-f908533f3d28
...
require (
	...
	github.com/PubMatic-OpenWrap/fastxml v0.0.0-20250402104810-c02580cc8c8c
