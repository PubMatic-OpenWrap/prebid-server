...
func TestRecordTLSHandshakeTime(t *testing.T) {
	...
	for _, test := range testCases {
		...
		m.RecordTLSHandshakeTime(openrtb_ext.BidderName(strings.ToLower(adapter)), test.in.tLSHandshakeDuration)

		assert.Equal(t, test.out.expectedDuration.Nanoseconds(), m.AdapterMetrics[strings.ToLower(adapter)].TLSHandshakeTimer.Sum(), test.description)
...
func TestMetrics_RecordDynamicFetchFailure(t *testing.T) {
	type fields struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			me := &Metrics{
				...
				ConnectionCounter:              tt.fields.ConnectionCounter,
				TMaxTimeoutCounter:             tt.fields.TMaxTimeoutCounter,
				ConnectionAcceptErrorMeter:     tt.fields.ConnectionAcceptErrorMeter,
				ConnectionCloseErrorMeter:      tt.fields.ConnectionCloseErrorMeter,
				ImpMeter:                       tt.fields.ImpMeter,
				AppRequestMeter:                tt.fields.AppRequestMeter,
				NoCookieMeter:                  tt.fields.NoCookieMeter,
				DebugRequestMeter:              tt.fields.DebugRequestMeter,
				RequestTimer:                   tt.fields.RequestTimer,
				RequestsQueueTimer:             tt.fields.RequestsQueueTimer,
				PrebidCacheRequestTimerSuccess: tt.fields.PrebidCacheRequestTimerSuccess,
				PrebidCacheRequestTimerError:   tt.fields.PrebidCacheRequestTimerError,
				StoredDataFetchTimer:           tt.fields.StoredDataFetchTimer,
				StoredDataErrorMeter:           tt.fields.StoredDataErrorMeter,
				StoredReqCacheMeter:            tt.fields.StoredReqCacheMeter,
				StoredImpCacheMeter:            tt.fields.StoredImpCacheMeter,
				AccountCacheMeter:              tt.fields.AccountCacheMeter,
				DNSLookupTimer:                 tt.fields.DNSLookupTimer,
				TLSHandshakeTimer:              tt.fields.TLSHandshakeTimer,
				BidderServerResponseTimer:      tt.fields.BidderServerResponseTimer,
				StoredResponsesMeter:           tt.fields.StoredResponsesMeter,
				RequestStatuses:                tt.fields.RequestStatuses,
				AmpNoCookieMeter:               tt.fields.AmpNoCookieMeter,
				CookieSyncMeter:                tt.fields.CookieSyncMeter,
				CookieSyncStatusMeter:          tt.fields.CookieSyncStatusMeter,
				SyncerRequestsMeter:            tt.fields.SyncerRequestsMeter,
				SetUidMeter:                    tt.fields.SetUidMeter,
				SetUidStatusMeter:              tt.fields.SetUidStatusMeter,
				SyncerSetsMeter:                tt.fields.SyncerSetsMeter,
				FloorRejectedBidsMeter:         tt.fields.FloorRejectedBidsMeter,
				ImpsTypeBanner:                 tt.fields.ImpsTypeBanner,
				ImpsTypeVideo:                  tt.fields.ImpsTypeVideo,
				ImpsTypeAudio:                  tt.fields.ImpsTypeAudio,
				ImpsTypeNative:                 tt.fields.ImpsTypeNative,
				TimeoutNotificationSuccess:     tt.fields.TimeoutNotificationSuccess,
				TimeoutNotificationFailure:     tt.fields.TimeoutNotificationFailure,
				PrivacyCCPARequest:             tt.fields.PrivacyCCPARequest,
				PrivacyCCPARequestOptOut:       tt.fields.PrivacyCCPARequestOptOut,
				PrivacyCOPPARequest:            tt.fields.PrivacyCOPPARequest,
				PrivacyLMTRequest:              tt.fields.PrivacyLMTRequest,
				PrivacyTCFRequestVersion:       tt.fields.PrivacyTCFRequestVersion,
				AdapterMetrics:                 tt.fields.AdapterMetrics,
				accountMetrics:                 tt.fields.accountMetrics,
				accountMetricsRWMutex:          tt.fields.accountMetricsRWMutex,
				exchanges:                      tt.fields.exchanges,
				modules:                        tt.fields.modules,
				MetricsDisabled:                tt.fields.MetricsDisabled,
				AdsCertRequestsSuccess:         tt.fields.AdsCertRequestsSuccess,
				AdsCertRequestsFailure:         tt.fields.AdsCertRequestsFailure,
				adsCertSignTimer:               tt.fields.adsCertSignTimer,
				ModuleMetrics:                  tt.fields.ModuleMetrics,
				OverheadTimer:                  tt.fields.OverheadTimer,
			}
			me.RecordDynamicFetchFailure(tt.args.pubId, tt.args.code, tt.args.source)
		})
	}
}
