...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("category_mapping.filesystem.directorypath", "/home/http/GO_SERVER/dmhbserverstatic/category-mapping")
	...
	v.SetDefault("gdpr.tcf1.fallback_gvl_path", "/home/http/GO_SERVER/dmhbserverstatic/tcf1/fallback_gvl.json")
