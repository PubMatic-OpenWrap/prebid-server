...
func Test_parseDuration(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "duration 00:00:-25 (= -25 seconds)", want: want{err: errors.New("invalid video duration")}, args: "00:00:-25"},
		...
		{name: "duration 00:00:25.0005458 (0 hrs 0 min  25 seconds 0005458 ms) - invalid max ms is 999", want: want{err: errors.New("invalid video duration")}, args: "00:00:25.0005458"},
		{name: "invalid duration 3:13:900 (3 hrs 13 min  900 seconds) = Invalid seconds )", want: want{err: errors.New("invalid video duration")}, args: "3:13:900"},
		{name: "invalid duration 3:13:34:44 (3 hrs 13 min 34 seconds :44=invalid) = ?? )", want: want{err: errors.New("invalid video duration")}, args: "3:13:34:44"},
		...
		{name: "duration = 56 (ambiguity w.r.t. HH:MM:SS.mmm format)", want: want{err: errors.New("invalid video duration")}, args: "56"},
		{name: "duration = :56 (ambiguity w.r.t. HH:MM:SS.mmm format)", want: want{err: errors.New("invalid video duration")}, args: ":56"},
		{name: "duration = :56: (ambiguity w.r.t. HH:MM:SS.mmm format)", want: want{err: errors.New("invalid video duration")}, args: ":56:"},
		{name: "duration = ::56 (ambiguity w.r.t. HH:MM:SS.mmm format)", want: want{err: errors.New("invalid video duration")}, args: "::56"},
		{name: "duration = 56.445 (ambiguity w.r.t. HH:MM:SS.mmm format)", want: want{err: errors.New("invalid video duration")}, args: "56.445"},
		{name: "duration = a:b:c.d (no numbers)", want: want{err: errors.New("invalid video duration")}, args: "a:b:c.d"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
