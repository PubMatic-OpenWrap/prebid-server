	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				...
				setup: func(mme *mock_metrics.MockMetricsEngine) {
					mockFeature.EXPECT().GetApplovinMaxSchainPercentage(111).Return(10)
					mockFeature.EXPECT().IsApplovinMaxSchainEnabled(111).Return(true)
					mockEngine.EXPECT().RecordRequestWithSchainRemoved("111")
					GetRandomNumberIn1To100 = func() int {
						return 5
					}
				},
