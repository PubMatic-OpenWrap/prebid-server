	...
	tests := []struct {
		...
		},
		{
			...
			want: want{
				...
				matchedPattern: "",
				isRegexSlot:    false,
				params:         []byte(`{"publisherId":"5890","adSlot":"ABCD","wrapper":{"version":0,"profile":1323},"keywords":[{"key":"test_key1","value":["test_value1","test_value2"]},{"key":"test_key2","value":["test_value1","test_value2"]}]}`),
				wantErr:        false,
			},
		},
		{
