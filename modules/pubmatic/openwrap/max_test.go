...
func Test_updateImpression(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: &openrtb2.Imp{ClickBrowser: 0, DisplayManager: "PubMatic_SDK", DisplayManagerVer: "1.2", Video: &openrtb2.Video{W: 300, H: 250, BAttr: []adcom1.CreativeAttribute{1, 2}}},
		},
		{
