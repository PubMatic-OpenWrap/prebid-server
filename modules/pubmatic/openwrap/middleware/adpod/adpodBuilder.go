...
import (
	...
	"github.com/PubMatic-OpenWrap/prebid-server/v2/endpoints/openrtb2/ctv/constant"
...
func (ab *adpodBuilderFastXML) Append(bid *openrtb2.Bid) error {
	...
	if strings.HasPrefix(bid.AdM, constant.HTTPPrefix) {
		...
		//get VAST version
		if value := adDoc.SelectAttrValue(vastTag, constant.VASTVersionAttribute); value != "" {
