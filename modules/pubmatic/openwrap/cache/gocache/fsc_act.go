...
const allDspFscAndActPcntQuery = "GetAllDspFscAndActPcntQuery"
...
func (c *cache) GetFSCAndACTThresholdsPerDSP() (fscMap map[int]int, actMap map[int]int, err error) {
	...
	if err != nil {
		c.metricEngine.RecordDBQueryFailure(allDspFscAndActPcntQuery, "", "")
		glog.Errorf(models.ErrDBQueryFailed, allDspFscAndActPcntQuery, "", "", err)
