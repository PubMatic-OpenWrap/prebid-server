...
type Cache interface {
	...
	// GetApsOwMapping resolves APS slot UUID to OW ad unit name and profile id: in-memory cache first, then fixed per-slot SQL on miss (see mysql.ApsOwMappingDB).
