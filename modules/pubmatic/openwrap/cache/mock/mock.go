...
// Source: /Users/test/prebid-server/modules/pubmatic/openwrap/cache/cache.go
...
func (m *MockCache) GetPartnerConfigMap(pubid, profileid, displayversion int, endpoint string) (map[int]map[string]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPartnerConfigMap", pubid, profileid, displayversion, endpoint)
...
func (mr *MockCacheMockRecorder) GetPartnerConfigMap(pubid, profileid, displayversion, endpoint interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPartnerConfigMap", reflect.TypeOf((*MockCache)(nil).GetPartnerConfigMap), pubid, profileid, displayversion, endpoint)
}
