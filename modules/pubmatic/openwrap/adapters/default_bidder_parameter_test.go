...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 216, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 265, len(schemaDefinitions), "Length of expected entries should match")
