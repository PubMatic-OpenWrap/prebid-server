...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 166, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 207, len(schemaDefinitions), "Length of expected entries should match")
