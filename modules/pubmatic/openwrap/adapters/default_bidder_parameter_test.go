...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 211, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 258, len(schemaDefinitions), "Length of expected entries should match")
