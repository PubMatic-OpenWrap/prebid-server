...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 159, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 197, len(schemaDefinitions), "Length of expected entries should match")
