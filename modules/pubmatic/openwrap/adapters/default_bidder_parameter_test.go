...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 168, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 209, len(schemaDefinitions), "Length of expected entries should match")
