...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 194, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 238, len(schemaDefinitions), "Length of expected entries should match")
