...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 218, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 268, len(schemaDefinitions), "Length of expected entries should match")
