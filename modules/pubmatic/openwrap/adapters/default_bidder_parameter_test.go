...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 223, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 273, len(schemaDefinitions), "Length of expected entries should match")
