...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 158, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 195, len(schemaDefinitions), "Length of expected entries should match")
