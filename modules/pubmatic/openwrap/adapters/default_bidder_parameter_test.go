...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 162, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 200, len(schemaDefinitions), "Length of expected entries should match")
