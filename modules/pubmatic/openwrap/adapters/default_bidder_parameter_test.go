...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 167, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 208, len(schemaDefinitions), "Length of expected entries should match")
