...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 174, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 210, len(schemaDefinitions), "Length of expected entries should match")
