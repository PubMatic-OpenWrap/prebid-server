...
func TestParseBidderParams(t *testing.T) {
	...
	assert.Equal(t, 184, len(adapterParams), "Length of expected entries should match")
...
func TestParseBidderSchemaDefinitions(t *testing.T) {
	...
	assert.Equal(t, 228, len(schemaDefinitions), "Length of expected entries should match")
