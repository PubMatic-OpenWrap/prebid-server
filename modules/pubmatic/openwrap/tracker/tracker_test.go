...
func TestGetTrackerInfo(t *testing.T) {
	...
	type args struct {
		...
		prebidExt *openrtb_ext.ExtResponsePrebid
	}
	tests := []struct {
		name string
		args args
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetTrackerInfo(tt.args.rCtx, tt.args.prebidExt); got != tt.want {
...
func Test_setFloorsDetails(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			setFloorsDetails(tt.args.tracker, tt.args.prebidExt)
			assert.Equal(t, tt.args.tracker, tt.want)
		})
	}
}
