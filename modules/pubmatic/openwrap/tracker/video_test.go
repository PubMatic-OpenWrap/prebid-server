...
func TestInjectVideoCreativeTrackers(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "vast_2.0_inline_pricing_with_inject_impression_tracker_false",
			args: args{
		...
		{
			name: "vast_3.0_inline_pricing_with_inject_impression_tracker_false",
			args: args{
		...
		{
			name: "wrapper_vast_2.0_with_inject_impression_tracker_false",
			args: args{
		...
		{
			name: "inline_vast_with_no_cdata_and_inject_imp_tracker_false",
			args: args{
		...
		{
			name: "wrapper_vast_with_no_cdata_and_inject_imp_tracker_false",
			args: args{
		...
		{
			name: "spaces_in_creative_with_inject_impression_tracker_false",
			args: args{
