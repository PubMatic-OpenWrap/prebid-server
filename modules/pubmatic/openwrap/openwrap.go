...
import (
	...
	ow_adapters "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/adapters"
	cache "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/cache"
	ow_gocache "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/cache/gocache"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/config"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/database/mysql"
	...
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/geodb/netacuity"
	metrics "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/metrics"
	metrics_cfg "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/metrics/config"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/models"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/profilemetadata"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/publisherfeature"
	"github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/unwrap"
...
func initOpenWrap(rawCfg json.RawMessage, moduleDeps moduledeps.ModuleDeps) (OpenWrap, error) {
	...
	sqlDB := mysql.New(mysqlDriver, cfg.Database, cfg.Cache)
	...
	owCache := ow_gocache.New(cache, sqlDB, cfg.Cache, &metricEngine)
