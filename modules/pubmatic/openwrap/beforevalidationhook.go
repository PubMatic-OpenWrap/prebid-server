...
func (m OpenWrap) handleBeforeValidationHook(
	...
	setFloorsExt(requestExt, rCtx.PartnerConfigMap, rCtx.IsMaxFloorsEnabled, m.pubFeatures.IsDynamicFloorEnabledPublisher(rCtx.PubID), rCtx.PubID, rCtx.ProfileID)
