				...
				moduleCtx: hookstage.ModuleInvocationContext{
					ModuleContext: hookstage.ModuleContext{
						"rctx": func() models.RequestCtx {
							...
							testRctx.MetricsEngine = mockEngine
							testRctx.SignalData = &openrtb2.BidRequest{
								Regs: &openrtb2.Regs{
									COPPA: -1,
								},
							}
