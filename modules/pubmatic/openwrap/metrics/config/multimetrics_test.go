...
import (
	...
	cfg "github.com/prebid/prebid-server/v4/config"
	metrics_cfg "github.com/prebid/prebid-server/v4/metrics/config"
	...
	mock "github.com/prebid/prebid-server/v4/modules/pubmatic/openwrap/metrics/mock"
...
func TestRecordFunctionForMultiMetricsEngine(t *testing.T) {
	...
	mockEngine.EXPECT().RecordCountryLevelPartnerThrottledRequests(endpoint, partner, country)
	...
	multiMetricEngine.RecordCountryLevelPartnerThrottledRequests(endpoint, partner, country)
