...
func TestOpenWrap_updateAppLovinMaxRequestSchain(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "schain_not_removed_from_request",
			rctx: &models.RequestCtx{
				Endpoint: models.EndpointAppLovinMax,
			},
			maxRequest: &openrtb2.BidRequest{
