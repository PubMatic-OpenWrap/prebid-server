...
func TestUpdateDevice(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: &openrtb2.Device{Geo: &openrtb2.Geo{City: "Delhi", UTCOffset: 3}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
