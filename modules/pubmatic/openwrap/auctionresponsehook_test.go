...
func Test_updateMultiFloorResponse(t *testing.T) {
	type args struct {
		bidResponse *openrtb2.BidResponse
	}
	tests := []struct {
		...
		{
			name: "single bid returned in response",
			args: args{
				bidResponse: &openrtb2.BidResponse{
					ID: "12345",
					SeatBid: []openrtb2.SeatBid{
		...
		{
			name: "multiple bids returned in response by pubmatic",
			args: args{
				bidResponse: &openrtb2.BidResponse{
					ID: "12345",
					SeatBid: []openrtb2.SeatBid{
		...
		{
			name: "multiple bids returned in response for different impressions by pubmatic",
			args: args{
				bidResponse: &openrtb2.BidResponse{
					ID: "12345",
					SeatBid: []openrtb2.SeatBid{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := updateMultiFloorResponse(tt.args.bidResponse)
			assert.Equal(t, tt.want, got)
		})
	}
}

func Test_trimSuffixWithPattern(t *testing.T) {
	type args struct {
		input string
	}
	tests := []struct {
