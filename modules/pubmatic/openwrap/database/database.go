...
type Database interface {
	...
	// GetApsOwMapping resolves APS slot UUID (imp.tagid) to OW ad unit name and profile id (cache first; on miss single-row query in mysql package — see mysql.ApsOwMappingDB).
	GetApsOwMapping(slotUUID string) (adUnitName string, profileID int, found bool)
