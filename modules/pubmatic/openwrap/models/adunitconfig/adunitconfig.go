...
type AdUnitConfig struct {
	...
	// Renderer interface{} `json:"regex,omitempty"`
}
type Content struct {
...
type VideoConfig struct {
	...
	PlayerSize   []int  `json:"playerSize,omitempty"`
	E2Etest      bool   `json:"e2etest,omitempty"`
...
type PC struct {
	Pubmatic *PM `json:"pubmatic,omitempty"`
}
...
type Video struct {
	...
	//temp
	PartnerConfig *PC `json:"partnerConfig,omitempty"`
}
