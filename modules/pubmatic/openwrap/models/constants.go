...
const (
	...
	GAMAdpodMinDuration = "min_ad_duration" // OW-OTT equivalent imp.vid.ext.adpod.adminduration
	GAMAdpodMaxDuration = "max_ad_duration" // OW-OTT equivalent imp.vid.ext.adpod.admaxduration
)
