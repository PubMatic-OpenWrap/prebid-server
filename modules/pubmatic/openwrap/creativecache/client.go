...
import (
	...
	metrics "github.com/prebid/prebid-server/v3/modules/pubmatic/openwrap/metrics/config"
...
func NewClient(httpClient *http.Client, conf *config.Cache, extCache *config.ExternalCache, metrics metrics.MultiMetricsEngine) Client {
	return &clientImpl{
...
type clientImpl struct {
	...
	metrics             metrics.MultiMetricsEngine
}
