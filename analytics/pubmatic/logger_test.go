...
func TestGetLogAuctionObjectAsURL(t *testing.T) {
	...
	tests := []struct {
		...
		// 		},
		// 		wlog: &WloggerRecord{record: record{PubID: 5890, ProfileID: "0", VersionID: "0", ServerLogger: 1, Slots: []SlotRecord{}, IntegrationType: "sdk"}},
		// 	},
		// },
		// {
		...
		// 			models.IP_HEADER:         []string{""},
		// 		},
		// 		wlog: &WloggerRecord{record: record{PubID: 5890, ProfileID: "0", VersionID: "0", ServerLogger: 1, ConsentString: "any-random-consent-string", Slots: []SlotRecord{}, IntegrationType: ""}},
		// 	},
		// },
		{
			name: "log gdpr flag",
			...
			want: want{
				...
				wlog: &WloggerRecord{record: record{PubID: 5890, ProfileID: "0", VersionID: "0", GDPR: 1, ServerLogger: 1, ConsentString: "", Slots: []SlotRecord{}, IntegrationType: ""}},
			},
		},
		// 	{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			logger, header, wlog := GetLogAuctionObjectAsURL(tt.args.ao, tt.args.rCtx, tt.args.logInfo, tt.args.forRespExt)
			...
			assert.Equal(t, tt.want.wlog, wlog, tt.name)
		})
	}
}
func TestGetLogAuctionObjectAsURLForFloorType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			logger, header, _ := GetLogAuctionObjectAsURL(tt.args.ao, tt.args.rCtx, tt.args.logInfo, tt.args.forRespExt)
