...
func New(cfg *config.Configuration, rateConvertor *currency.RateConverter) (r *Router, err error) {
	...
	theExchange := exchange.NewExchange(adapters, cacheClient, cfg, syncersByBidder, r.MetricsEngine, cfg.BidderInfos, gdprPermsBuilder, tcf2CfgBuilder, rateConvertor, categoriesFetcher, adsCertSigner, replacer.NewReplacer())
