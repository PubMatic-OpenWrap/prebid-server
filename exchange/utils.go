...
func updateContentObjectForBidder(allBidderRequests []BidderRequest, requestExt *openrtb_ext.ExtRequest) {
	...
	if requestExt != nil && requestExt.Prebid.Transparency != nil {
		...
		var (
			rule openrtb_ext.TransparencyRule
			ok   bool
		)
...
func getTransparencyRules(transparencyExt *openrtb_ext.TransparencyExt) (map[string]openrtb_ext.TransparencyRule, openrtb_ext.TransparencyRule) {
