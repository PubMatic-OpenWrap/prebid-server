...
func splitImps(imps []openrtb2.Imp) (map[string][]openrtb2.Imp, []error) {
	...
	splitImps := make(map[string][]openrtb2.Imp, len(imps))
	var errList []error
...
func parseImpExts(imps []openrtb2.Imp) ([]map[string]json.RawMessage, error) {
