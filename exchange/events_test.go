...
func TestModifyBidVAST(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantAdM: `<VAST version="3.0"><Ad><Wrapper><Creatives><Creative><Linear><TrackingEvents><Tracking event="start"><![CDATA[http://company.tracker.com?e=2]]></Tracking><Tracking event="firstQuartile"><![CDATA[http://company.tracker.com?e=4]]></Tracking><Tracking event="midpoint"><![CDATA[http://company.tracker.com?e=3]]></Tracking><Tracking event="thirdQuartile"><![CDATA[http://company.tracker.com?e=5]]></Tracking><Tracking event="complete"><![CDATA[http://company.tracker.com?e=6]]></Tracking></TrackingEvents></Linear><NonLinearAds><TrackingEvents><Tracking event="start"><![CDATA[http://company.tracker.com?e=2]]></Tracking><Tracking event="firstQuartile"><![CDATA[http://company.tracker.com?e=4]]></Tracking><Tracking event="midpoint"><![CDATA[http://company.tracker.com?e=3]]></Tracking><Tracking event="thirdQuartile"><![CDATA[http://company.tracker.com?e=5]]></Tracking><Tracking event="complete"><![CDATA[http://company.tracker.com?e=6]]></Tracking></TrackingEvents></NonLinearAds></Creative></Creatives><AdSystem><![CDATA[prebid.org wrapper]]></AdSystem><VASTAdTagURI><![CDATA[http://vast_tag_inline.xml]]></VASTAdTagURI><Impression></Impression></Wrapper></Ad></VAST>`,
		},
	}
