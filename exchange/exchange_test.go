...
func TestCategoryMapping(t *testing.T) {
	...
	bidCategory, adapterBids, rejections, err := applyCategoryMapping(nil, &openrtb2.BidRequest{}, &requestExt, adapterBids, categoriesFetcher, targData, &randomDeduplicateBidBooleanGenerator{})
...
func TestBidRejectionErrors(t *testing.T) {
	...
	for _, test := range testCases {
		...
		bidCategory, adapterBids, rejections, err := applyCategoryMapping(nil, &openrtb2.BidRequest{}, &test.reqExt, adapterBids, categoriesFetcher, targData, &randomDeduplicateBidBooleanGenerator{})
...
func TestCategoryMappingTwoBiddersOneBidEachNoCategorySamePrice(t *testing.T) {
	...
	for i := 1; i < 10; i++ {
		...
		bidCategory, _, rejections, err := applyCategoryMapping(nil, &openrtb2.BidRequest{}, &requestExt, adapterBids, categoriesFetcher, targData, &randomDeduplicateBidBooleanGenerator{})
...
func TestCategoryMappingTwoBiddersManyBidsEachNoCategorySamePrice(t *testing.T) {
	...
	_, adapterBids, rejections, err := applyCategoryMapping(nil, &openrtb2.BidRequest{}, &requestExt, adapterBids, categoriesFetcher, targData, &fakeRandomDeduplicateBidBooleanGenerator{true})
