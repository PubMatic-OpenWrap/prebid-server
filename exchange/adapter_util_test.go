...
import (
	...
	metrics "github.com/PubMatic-OpenWrap/prebid-server/metrics/config"
...
func TestBuildBidders(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			bidderInfos:   map[string]adapters.BidderInfo{"appnexus": infoActive, "lifestreet": infoActive},
